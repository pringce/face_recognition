...
def SE_ResNeXt(input_image, bottleneck_layer_size=512, is_training = False, group=32, data_format='channels_last', net_depth=50):
    bn_axis = -1 if data_format == 'channels_last' else 1
    ...
    logits_output = tf.layers.dense(pooled_inputs, bottleneck_layer_size,
                                kernel_initializer=tf.contrib.layers.xavier_initializer(),
